...
public static class Dokan
{
    ...
    public static void Mount(this IDokanOperations operations, string mountPoint, DokanOptions mountOptions,
        ILogger logger = null) => Mount(operations, mountPoint, mountOptions, 0, logger);
    ...
    /// <exception cref="DokanException">If the mount fails.</exception>
    public static void Mount(this IDokanOperations operations, string mountPoint, DokanOptions mountOptions,
        int threadCount, ILogger logger = null) => Mount(operations, mountPoint, mountOptions, threadCount, DOKAN_VERSION, logger);
    ...
    /// <exception cref="DokanException">If the mount fails.</exception>
    public static void Mount(this IDokanOperations operations, string mountPoint, DokanOptions mountOptions,
        int threadCount, int version, TimeSpan timeout, ILogger logger = null) => Mount(operations, mountPoint, mountOptions, threadCount, version, timeout, string.Empty, 512, 512, logger);
    ...
    /// <exception cref="DokanException">If the mount fails.</exception>
    public static void Mount(this IDokanOperations operations, string mountPoint, DokanOptions mountOptions,
        int threadCount, int version, TimeSpan timeout, string uncName, ILogger logger = null) => Mount(operations, mountPoint, mountOptions, threadCount, version, timeout, uncName, 512, 512, logger);
    ...
    public static class Notify
    {
        ...
        public static bool Create(string FilePath, bool isDirectory) => NativeMethods.DokanNotifyCreate(FilePath, isDirectory);
        ...
        public static bool Delete(string FilePath, bool isDirectory) => NativeMethods.DokanNotifyDelete(FilePath, isDirectory);
        ...
        /// <returns>true if notification succeeded.</returns>
        /// <remarks><see cref="DokanOptions.EnableNotificationAPI"/> must be set in the mount options for this to succeed.</remarks>
        public static bool Update(string FilePath) => NativeMethods.DokanNotifyUpdate(FilePath);
        ...
        /// <returns>true if notification succeeded.</returns>
        /// <remarks><see cref="DokanOptions.EnableNotificationAPI"/> must be set in the mount options for this to succeed.</remarks>
        public static bool XAttrUpdate(string FilePath) => NativeMethods.DokanNotifyXAttrUpdate(FilePath);
